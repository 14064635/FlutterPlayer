...
class AudioPlayer {
  ...
  /// Strem of player pause.
  ///
  /// Events are sent every time an audio is pause
  Stream<void> get onPlayerPause => _pauseController.stream;


  ///Strem of player
  ///
  /// Events are sent every time an audio is play
  Stream<void> get onPlayerResume => _resumeController.stream;
  ...
  ///Handler of player pause
  ///Events are sent when an audio is pause
  /// Use[onPlayerPause] instead.
  @deprecated
  VoidCallback pauseHandler;

  ///Handler of player resume
  ///Events are sent when an audio is play
  /// Use[onPlayerResume] instead.
  @deprecated
  ...
  static Future<void> _doHandlePlatformCall(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case 'audio.pause':
        ...
        player._pauseController.add(null);
        player.pauseHandler?.call();
        break;
      case 'audio.resume':
        player.state = AudioPlayerState.PLAYING;
        player._resumeController.add(null);
        player.resumeHandler?.call();
        break;
      default:
  ...
  ///close android media service
  ///user android platform please user this method for close Android media service
  Future<void> closeMediaService() {
    return _invokeMethod('closeService');
  }
}
